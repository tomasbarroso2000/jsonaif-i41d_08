...
class JsonParserDynamicTest {
    ...
    @Test fun parseArray() {
        ...
        val ps = JsonParserDynamic.parse(json, Person::class) as List<Person>
        assertEquals(3, ps.size)
        assertEquals("Ze Manel", ps[0].name)
    ...
    @Test fun parseAccountWithArrayOfStrings() {
        ...
        val ps = JsonParserDynamic.parse(json, Account::class) as Account
    ...
    @Test fun parsePersonWithDifferentPropertyNames(){
        ...
        val ps = JsonParserDynamic.parse(json, PersonAlternative::class) as PersonAlternative
    ...
    @Test fun parseTeacherWithDatePropertyUsingJsonConverter(){
        ...
        val ps = JsonParserDynamic.parse(json, Teacher::class) as Teacher
