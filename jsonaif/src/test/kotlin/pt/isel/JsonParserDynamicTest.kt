...
class JsonParserDynamicTest {
    @Test fun parseSimpleObjectViaProperties() {
        ...
        val student = JsonParserDynamic.parse(json, Student::class)
    ...
    @Test fun parseArrayOfStudentUsingSetters() {
        ...
        val ps = JsonParserDynamic.parseArray(json, Student::class)
    ...
    @Test fun parseClassroomWithArrayOfStudents() {
        ...
        val ps = JsonParserDynamic.parse(json, Classroom::class)
    ...
    @Test fun parseListOfClassroom() {
        ...
        val ps = JsonParserDynamic.parseArray(json, Classroom::class)
    ...
    @Test fun parseListOfStudentsWithDifferentPropertyNames() {
        ...
        val ps = JsonParserDynamic.parseArray(json, StudentAlternative::class)
    ...
    @Test fun parseStudentWithDatePropertyUsingJsonConvert(){
        ...
        val ps = JsonParserDynamic.parse(json, StudentAlternative::class)
    ...
    @Test fun parseDateAlternative(){
        ...
        val ps = JsonParserDynamic.parse(json, DateAlternative::class)
