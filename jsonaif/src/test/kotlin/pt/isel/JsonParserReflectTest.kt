...
class JsonParserReflectTest {
    ...
    @Test fun parseSimpleObjectViaProperties() {
        ...
        val student = JsonParserReflect.parse(json, Student::class)
    ...
    @Test fun parseArrayOfStudentUsingSetters() {
        ...
        val ps = JsonParserReflect.parseArray(json, Student::class)
    ...
    @Test fun parseSimpleObjectViaConstructor() {
        ...
        val p = JsonParserReflect.parse(json, Person::class)
    ...
    @Test fun parseArray() {
        ...
        val ps = JsonParserReflect.parseArray(json, Person::class)
        assertEquals(3, ps.size)
        assertEquals("Ze Manel", ps[0].name)
    ...
    @Test fun parseClassroomWithArrayOfStudents() {
        ...
        val ps = JsonParserReflect.parse(json, Classroom::class)
    ...
    @Test fun parseAccountWithArrayOfStrings() {
        ...
        val ps = JsonParserReflect.parse(json, Account::class)
    ...
    @Test fun parseListOfClassroom() {
        ...
        val ps = JsonParserReflect.parseArray(json, Classroom::class)
    ...
    @Test fun parseListOfStudentsWithDifferentPropertyNames() {
        ...
        val ps = JsonParserReflect.parseArray(json, StudentAlternative::class)
    ...
    @Test fun parsePersonWithDifferentPropertyNames(){
        ...
        val ps = JsonParserReflect.parse(json, PersonAlternative::class)
    ...
    @Test fun parseStudentWithDatePropertyUsingJsonConvert(){
        ...
        val ps = JsonParserReflect.parse(json, StudentAlternative::class)
    ...
    @Test fun parseTeacherWithDatePropertyUsingJsonConverter(){
        ...
        val ps = JsonParserReflect.parse(json, Teacher::class)
